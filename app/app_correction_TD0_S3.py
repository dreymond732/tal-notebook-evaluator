...
CHECKS = [
    ...
    {"label": "Observation critique", "source": ["ponctuation"], "output": None, "points": 1.0, "feedback": "Expliquer au moins une limite de split() : ponctuation, casse, contraction ou morphologie."},
]
