...
CHECKS = [
    ...
    {"label": "Lemmes de noms", "source": ["token.lemma_"], "source_any": ["token.pos_ == \"NOUN\"", "token.pos_ == 'NOUN'", "token.pos_ in"], "output": "Résultat Q2 :", "points": 1.0, "feedback": "Ne compter que les lemmes des noms."},
