...
5. Déposer le notebook exécuté sur le [site d’autoévaluation TAL](https://hazigo.duckdns.org/universite/tal/) en choisissant la séance correspondante. Les résultats automatiques contrôlent des traces enregistrées ; l’enseignant relit les interprétations et les choix méthodologiques.
